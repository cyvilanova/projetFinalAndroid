...
public class MyOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Product p1 = new Product("POUR ORDER 1", "description1", 15.00, 42, "");
        p1.setId(1);
        Product p12 = new Product("POUR ORDER 1-2", "description1-2", 115.00, 4, "");
        p12.setId(2);
        Product p2 = new Product("POUR ORDER 2", "description2", 15.00, 42, "");
        p2.setId(3);
